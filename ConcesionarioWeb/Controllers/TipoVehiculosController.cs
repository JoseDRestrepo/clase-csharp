...
public class TipoVehiculosController : Controller
{
    ...
    public async Task<IActionResult> Create([Bind("Nombre")] TipoVehiculo tipoVehiculo)
    {
        if (ModelState.IsValid)
        {
            ...
            TempData["msg"] = "Tipo de vehículo creado exitosamente.";
            return RedirectToAction(nameof(Index));
        }
        TempData["msg"] = "Error al crear el tipo de vehículo.";
        return View(tipoVehiculo);
    }
    ...
    public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre")] TipoVehiculo tipoVehiculo)
    {
        ...
        try
        {
            ...
            await _context.SaveChangesAsync();
            TempData["msg"] = "Tipo de vehículo actualizado exitosamente.";
        }
        catch (DbUpdateConcurrencyException)
        {
            if (!_context.TipoVehiculos.Any(e => e.Id == id)) return NotFound();
            else
            TempData["msg"] = "Error al actualizar el tipo de vehículo.";
            throw;
        }
        return RedirectToAction(nameof(Index));
    }
    ...
    public async Task<IActionResult> DeleteConfirmed(int id)
    {
        ...
        if (tipoVehiculo != null)
        {
            ...
            await _context.SaveChangesAsync();
            TempData["msg"] = "Tipo de vehículo eliminado exitosamente.";
        }
        else
        {
            TempData["msg"] = "Error al eliminar el tipo de vehículo.";
        }
        return RedirectToAction(nameof(Index));
    }
}
